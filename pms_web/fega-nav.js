  ...
  constructor(){
    ...
    r.innerHTML = `
      <nav class="rk-nav" role="navigation" aria-label="Primary">
        <div class="bar">
          <a class="brand" href="checkins_checkouts.html" aria-label="Home">
            <span class="b1">Fakkul Ehraam</span><span class="b2">Miqaat 1447</span>
          </a>
          <div class="links" role="menubar">
            ${[

              { href: "only-docx.html",   text: "DOCX" },     
        { href: "only-pdf.html", text: "PDF" },
            ].map(l => `
